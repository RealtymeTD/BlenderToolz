...
"""
    November 17, 2025
    Finally! Got the animations in Unreal on the MetaHumans, took me what feels like
    forever, but now I can confidently say I have a fight scene that I am gonna nail, 
    downloading some sounds as well for SFX
"""
...
for glb in Path(GLB_FOLDER).iterdir():
    if glb.suffix == ".glb":
        ...
        bpy.ops.export_scene.fbx(
            filepath = Path(glb.parent, 
                            glb.name.replace("glb", "fbx") ).as_posix(),
